...
> Todo List project is a Single Page Application (SPA) created with React that allows users to Make lists of todo event with unique functionalities such as add, remove, edit, checkbox, etc. It is simple and easy to use. Enjoy it!
...
<details>
  ...
  <ul>
    <li><a href="https://github.com/dialite/react-todo-list.git">Todo List (React)</a></li>
  </ul>
</details>
<details>
